  ...
  methods: {
    ...
    getAll: function getAll() {
      ...
      (0, _axios.default)({
        ...
        _this.isAdd = false;
        _this.tasks1 = data.data.filter(function (el) {
          return el.category === 0;
        });
        _this.tasks2 = data.data.filter(function (el) {
          return el.category === 1;
        });
        _this.tasks3 = data.data.filter(function (el) {
          return el.category === 2;
        });
        _this.tasks4 = data.data.filter(function (el) {
              ...
              _c("div", { staticClass: "category" }, [
                _c("div", { staticClass: "card" }, [
                  ...
                  _c(
                    ...
                    _vm._l(_vm.tasks1, function(todo) {
              ...
              _c("div", { staticClass: "category" }, [
                _c(
                  ...
                  [
                    _c("h3", [_vm._v("To Do")]),
                    _vm._v(" "),
                    _vm._l(_vm.tasks2, function(todo) {
                      return _c("div", { key: todo.id, staticClass: "task" }, [
                        (todo.category === 0
                        ? false
                        : true)
              ...
              _c("div", { staticClass: "category" }, [
                _c(
                  ...
                  [
                    _c("h3", [_vm._v("Doing")]),
                    _vm._v(" "),
                    _vm._l(_vm.tasks3, function(todo) {
                      return _c("div", { key: todo.id, staticClass: "task" }, [
                        (todo.category === 0
                        ? false
                        : true)
              ...
              _c("div", { staticClass: "category" }, [
                _c(
                  ...
                  [
                    _c("h3", [_vm._v("Done")]),
                    _vm._v(" "),
                    _vm._l(_vm.tasks4, function(todo) {
                      return _c("div", { key: todo.id, staticClass: "task" }, [
                        (todo.category === 0
                        ? false
                        : true)
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35711" + '/');
